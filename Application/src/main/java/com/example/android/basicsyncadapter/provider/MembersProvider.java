...
public class MembersProvider extends ContentProvider {
    MembersDatabase mDatabaseHelper;

    /**
     * Content authority for this provider.
     */
//    private static final String AUTHORITY = FeedContract.CONTENT_AUTHORITY;
    private static final String AUTHORITY = MembersContract.CONTENT_AUTHORITY;
...
//        sUriMatcher.addURI(AUTHORITY, "entries/*", ROUTE_ENTRIES_ID);
        sUriMatcher.addURI(AUTHORITY, "members", ROUTE_ENTRIES);
        sUriMatcher.addURI(AUTHORITY, "members/*", ROUTE_ENTRIES_ID);
    }

    @Override
    public boolean onCreate() {
        mDatabaseHelper = new MembersDatabase(getContext());
        return true;
    }
     ...
     */
    static class MembersDatabase extends SQLiteOpenHelper {
        /** Schema version. */
        ...
        private static final String SQL_CREATE_ENTRIES =
                "CREATE TABLE " + MembersContract.Entry.TABLE_NAME + " (" +
                        MembersContract.Entry._ID + " INTEGER PRIMARY KEY," +
                        MembersContract.Entry.COLUMN_USERNAME + TYPE_TEXT + COMMA_SEP +
                        MembersContract.Entry.COLUMN_NICKNAME    + TYPE_TEXT + COMMA_SEP +
                        MembersContract.Entry.COLUMN_EMAIL + TYPE_TEXT + COMMA_SEP +
                        MembersContract.Entry.COLUMN_GRP+ TYPE_TEXT + ")";

        /** SQL statement to drop "entry" table. */
        private static final String SQL_DELETE_ENTRIES =
                "DROP TABLE IF EXISTS " + MembersContract.Entry.TABLE_NAME;
